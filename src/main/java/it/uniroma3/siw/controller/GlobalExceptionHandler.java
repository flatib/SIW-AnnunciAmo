...
public class GlobalExceptionHandler {
    ...
    public String handleAnnuncioNotFound(AnnuncioNotFoundException e, Model model) {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public String handleCategoriaNotFound(CategoriaNotFoundException e, Model model) {
        model.addAttribute("errorMessage", e.getMessage());
        return "error/404";
    }
