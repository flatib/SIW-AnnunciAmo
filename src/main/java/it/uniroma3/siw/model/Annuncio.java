...
public class Annuncio {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "annunci_seq_gen")
	@SequenceGenerator(name = "annunci_seq_gen", sequenceName = "annunci_seq", allocationSize = 1)
	private Long id;
