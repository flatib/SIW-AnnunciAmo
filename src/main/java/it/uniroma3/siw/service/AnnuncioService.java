...
public class AnnuncioService {
	...
	@Transactional(readOnly = true)
    public Page<Annuncio> searchPaginated(String nome, Long categoria, Double prezzo, int page, int size) {
        return annuncioRepository.findFilteredAnnunciPaginated(nome, categoria, prezzo, PageRequest.of(page, size));
    }
